/* Cluster Func_8011e50..Func_8011e50 extracted from goldensun/asm/rom_9000/rom_11ce0_a_c_c_a.s.
 *
 ...
 * goldensun/stage1.ld.
 */
int Func_8011e50(unsigned char *param_1, unsigned int param_2)
{
    int v;
    if (param_2 <= 7)
