/* Cluster Func_800d7e8..Func_800d7e8 extracted from goldensun/asm/rom_9000/rom_d654_a_c_a.s.
 *
 ...
 * goldensun/stage1.ld.
 */
/* Func_800d7e8 (ActorCmd_Stop) — actor[0] = &.L13240; *(u16*)(actor+4) = 0;
