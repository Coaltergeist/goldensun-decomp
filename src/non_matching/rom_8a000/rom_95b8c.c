 ...
 *   `ldr r3,[r3,r1]` (computed index = base, gScript_0809f0a4 ptr = offset); candidate emits
 *   `ldr r3,[r1,r3]`. Restructure so the index expression is the pointer base, e.g.
 *   `*(u32*)((((iwram_3001800>>2)&1)<<2) + (char*)gScript_0809f0a4)`; try variants.
 */
extern unsigned int iwram_3001800;
extern unsigned int gScript_0809f0a4[] __asm__("gScript_0809f0a4");

void Func_8095b8c(void *p)
{
    unsigned int v = gScript_0809f0a4[(iwram_3001800 >> 2) & 1];
