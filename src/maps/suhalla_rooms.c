...
void OvlFunc_962_2008240(void)
{
    ...
    if (__GetFlag(0x98a) == 0) {
        ...
        __MapActor_TravelToAnimWait(0, c_170, 0xa0);
        __Func_8092adc(0, c_c000, 0);
        __Func_809233c(0x13, 0, c_neg_10, c_c000);
        ...
        __CutsceneWait(0x14);
        __MapActor_SetSpeed(0x13, c_sp1, c_sp2);
        __Func_8092304(0x13, 0, c_neg_10);
        __Func_8092adc(0x13, 0, 0);
        __CutsceneWait(0x1e);
        __Func_8092adc(0x13, 0xe000, 0);
        __CutsceneWait(0x1e);
        __Func_8092adc(0x13, 0, 0);
        __CutsceneWait(0x1e);
        __MapActor_Emote(0x13, c_100, 0x28);
        ...
        __CutsceneWait(0xa);
        __MapActor_SetSpeed(0x13, c_sp1, c_sp2);
        __Func_8092304(0x13, 0, c_neg_18);
        __Func_8092304(0x13, 0x30, 0);
        __Func_8092adc(0x13, c_c000, 0);
        __CutsceneWait(0x1e);
        __ActorMessage(0x13, 0);
        __CutsceneWait(0x14);
        __MapActor_Emote(0x13, c_100, 0x28);
        __ActorMessage(0x13, 0);
        __CutsceneWait(0x14);
        __MapActor_Emote(0x14, c_102, 0x28);
        __ActorMessage(0x14, 0);
        __CutsceneWait(0xa);
        __Func_8092adc(0x13, c_2000, 0);
        __CutsceneWait(0x14);
        __ActorMessage(0x13, 0);
        __CutsceneWait(0xa);
        __Func_80925cc(0x15, 2);
        ...
        __Func_8092adc(0x13, c_c000, 0);
        __CutsceneWait(0x1e);
        __MapActor_Emote(0x13, c_107, 0x28);
        __ActorMessage(0x13, 0);
        __CutsceneWait(0xa);
        __Func_809259c(0x14, 2);
        __Func_80925cc(0x15, 2);
        __CutsceneWait(0x14);
        __MapActor_SetSpeed(0, c_sp1, c_sp2);
        __MapActor_TravelToAnimWait(0, c_170, 0x68);
        ...
        __ActorMessage(0x13, 0);
        __CutsceneWait(0x14);
        __MapActor_Emote(0x13, c_102, 0x32);
        __ActorMessage(0x13, 0);
        __CutsceneWait(0xa);
        __Func_80925cc(0x14, 2);
        __CutsceneWait(0x14);
        ...
        __CutsceneWait(0x1e);
        __CutsceneWait(0xa);
        __MapActor_Emote(0x13, c_102, 0x28);
        __ActorMessage(0x13, 0);
        __CutsceneWait(0xa);
        __MapActor_DoAnim(0x14, 4);
        __CutsceneWait(0x14);
        ...
        __ActorMessage(0x14, 0);
        __CutsceneWait(0xa);
        __MapActor_Emote(0, c_102, 0);
        __MapActor_Emote(0x13, c_102, 0x50);
        __MapActor_Emote(0x15, c_102, 0x32);
        __ActorMessage(0x15, 0);
        __CutsceneWait(0xa);
        __Func_80925cc(0x15, 2);
        __CutsceneWait(0x14);
