/* save.c -- consolidated flash-save TU. */
#include "gba/types.h"
#include "nonmatching.h"

/* Shared magic/data blob (baserom 0x79b0..0x7a0c), referenced by several
   functions below via .L79b0 ("CAMELOT") / .L79b8 ("CAMELOTT" + data). */
INCLUDE_ASM("asm/save/save_data.s");
extern const char sMagic[]  __asm__(".L79b0");
extern const char sMagicT[] __asm__(".L79b8");
