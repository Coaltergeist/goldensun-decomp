// fakematch
/* Cluster Func_80038fc..Func_80038fc extracted from goldensun/asm/rom_c0/rom_3650_c_c_c.s.
 *
 * Total .text for this TU = 64 bytes (= 0x40).
 * Preserves the original ROM layout when slotted between
 * asm/rom_c0/rom_3650_c_c_c_a.o and asm/rom_c0/rom_3650_c_c_c_c.o in
 * goldensun/stage1.ld.
 */
#include "gba/types.h"
#include "gba/io.h"
