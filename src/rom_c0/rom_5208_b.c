 ...
 * goldensun/stage1.ld.
 *
 * gPhysVec is a 3-element fx32 vector (the physics-state position per
 * FF SetPhysVec name). The earlier `(char *)&gPhysVec + N` cast form
