...
extern unsigned char Value_4[] asm("0x79");
extern unsigned char Value_5[] asm("0x7a");
extern unsigned char Result_1[] asm(".L2eac");
extern unsigned char Result_2[] asm(".L2ef4");
extern unsigned char Result_3[] asm(".L2f3c");
extern unsigned char Result_4[] asm(".L2f84");
extern unsigned char Result_5[] asm(".L2fcc");
extern unsigned char Result_default[] asm(".L2e7c");

void *OvlFunc_947_2009440(void) {
