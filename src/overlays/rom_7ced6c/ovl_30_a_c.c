...
extern unsigned char Result_1[] asm(".L3310");
extern unsigned char Result_2[] asm(".L3358");
extern unsigned char Result_3[] asm(".L33a0");
extern unsigned char Result_4[] asm(".L3400");
extern unsigned char Result_5[] asm(".L3448");
extern unsigned char Result_default[] asm(".L3478");

void *OvlFunc_946_2008cc4(void) {
