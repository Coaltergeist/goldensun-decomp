...
extern unsigned char Result_1[] asm(".L6ad8");
extern unsigned char Result_2[] asm(".L6c10");
extern unsigned char Result_3[] asm(".L6d60");
extern unsigned char Result_default[] asm(".L6ec8");
