...
extern unsigned char Result_1[] asm(".L1c80");
extern unsigned char Result_2[] asm(".L1cc0");
extern unsigned char Result_3[] asm(".L1cfc");
extern unsigned char Result_default[] asm(".L1c7c");

void *OvlFunc_935_200808c(void) {
