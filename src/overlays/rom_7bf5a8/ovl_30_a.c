...
extern unsigned char Result_1[] asm(".L18cc");
extern unsigned char Result_2[] asm(".L1a34");
extern unsigned char Result_3[] asm(".L1b9c");
extern unsigned char Result_default[] asm(".L189c");

void *OvlFunc_935_2008030(void) {
