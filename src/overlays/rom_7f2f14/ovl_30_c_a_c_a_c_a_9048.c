...
void OvlFunc_968_2009048(void)
{
...

    {
        ...
        __Func_8010704(0x23, 8, 1, 3, destination_x, destination_y);
    }
    {
        ...
        __CopyMapTiles(0x23, 8, 0x17, 8, width, height);
        __CopyMapTiles(0x63, 8, 0x57, 8, width, height);

        {
            ...
            asm volatile("" : "+r"(destination_x), "+r"(destination_y));
            __Func_8010704(0x39, 0x37, 3, 3,
                           destination_x, destination_y);
        }
        __CopyMapTiles(0x39, 0x37, 0x2e, 0x37, height, height);
        __CopyMapTiles(0x79, 0x37, 0x6e, 0x37, height, height);
    }
}
