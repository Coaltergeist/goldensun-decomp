...
static inline void ClearActorFlags(struct Actor *actor, u32 mask)
{
    actor->flags &= mask;
}

static inline void EnableActorFlags(struct Actor *actor, u32 mask)
{
    actor->flags = mask | actor->flags;
}
...
static inline void CompleteActorScene(int actor_id, int emote_actor_id)
{
    ...
    __Func_80921c4(actor_id, 0xb4, 0x30a);
    __Func_80921c4(actor_id, 0xb4, 700);
...
void OvlFunc_943_20091c8(void)
{
    ...
    if (__GetFlag(0x911) && !__GetFlag(0x922)) {
        ...
        __Func_80921c4(0x14, 0xca, 0x330);
        __CutsceneWait(1);
        set_mask = 1;
