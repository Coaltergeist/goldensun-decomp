...
extern int OvlFunc_898_2009674(u8 *actor, u8 *target, int command, int option);

/* 相手役を選び、接触時の動作を更新する */
int OvlFunc_898_2008314(u8 *actor)
{
    ...
    if (OvlFunc_898_2009674(actorReg, target, 0x20, 0) == 0) {
        ...
        OvlFunc_898_2009674(actorReg, target, command, option);
    }
