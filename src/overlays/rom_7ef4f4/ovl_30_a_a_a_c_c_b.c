/* OvlFunc_965_20089f4 extracted from
 * goldensun/asm/overlays/rom_7ef4f4/ovl_30_a_a_a_c_c.s.
...
unsigned char *OvlFunc_965_20089f4(int x, int y, int z, int actor_id)
{
    unsigned char *actor;
