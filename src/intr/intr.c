...
void gfree(u32);
extern s16 ewram_2002000__m __asm__("ewram_2002000");
extern u8 ewram_2002240[];
extern u8 ewram_20023b0[];
extern u8 gDebugMode__a1 __asm__("gDebugMode");
extern vs32 gKeyHeld;
extern vs32 gKeyRepeat;
...
extern vu8 iwram_3001ca0__a1 __asm__("iwram_3001ca0");
...
extern vu16 iwram_3001d28__m __asm__("iwram_3001d28");
extern s32 iwram_3001e40;
extern s8 iwram_3001e44__m __asm__("iwram_3001e44");
extern u8 iwram_3001f58__a1 __asm__("iwram_3001f58");
extern vu16 iwram_3001f5c;
extern u8 iwram_3007a00[];
extern s32 gIWRAMHeap_end;

static inline void VBlankIntrWait(void) {
    iwram_3001d28__m &= 0xFFFE;
    do {
        __asm__ volatile ("swi 0x2");
    } while ((iwram_3001d28__m & 1) == 0);
}
...
void WaitFrames(u32 frames)
{
    ...
    for (i = 0; i < frames; i++) {
        ...
        if (gSleepMode && iwram_3001ca0__a1 == 0) {
            s32 n;
...
extern s32 gKeyPress__a1 __asm__("gKeyPress");
...
void UpdateKeyPressRepeat(void) {
    ...
    gKeyPress__a1 = (gKeyHeld ^ iwram_3001cf4) & gKeyHeld;
