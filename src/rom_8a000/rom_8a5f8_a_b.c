/* Cluster Func_808a8d0..Func_808a8d0 extracted from goldensun/asm/rom_8a000/rom_8a5f8_a.s.
 *
 ...
 * goldensun/stage1.ld.
 */
/* Func_808a8d0 (GetMapArea) — signed byte at offset 2 of an 8-byte-stride table
