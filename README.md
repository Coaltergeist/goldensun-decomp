...
- **3,348 / 5,741 known original Thumb functions have matching C (58.32%)**, including **23 registered fakematches**. Excluding those entries: **3,325 / 5,741 (57.92%)**. The 53 ARM functions remain assembly. This 2026-09-13 snapshot uses fixed original addresses, excludes compiler call trampolines, and counts shared overlay implementations once. See [progress accounting](PROGRESS.md); run `python3 tools/progress.py` after a fresh build for current counts.
