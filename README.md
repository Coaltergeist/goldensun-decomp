...
- **3,125 / 5,741 known original Thumb functions have matching C (54.43%)**, including **23 registered fakematches**. Excluding those entries: **3,102 / 5,741 (54.03%)**. The 53 ARM functions remain assembly. This 2026-09-13 snapshot uses fixed original addresses, excludes compiler call trampolines, and counts shared overlay implementations once. See [progress accounting](PROGRESS.md); run `python3 tools/progress.py` after a fresh build for current counts.
