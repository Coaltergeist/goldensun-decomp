...
- **3,029 / 5,741 known original Thumb functions have matching C (52.76%)**, including **30 registered fakematches**. Excluding those entries: **2,999 / 5,741 (52.24%)**. The 53 ARM functions remain assembly. This 2026-09-10 snapshot uses fixed original addresses, excludes compiler call trampolines, and counts shared overlay implementations once. See [progress accounting](PROGRESS.md); run `python3 tools/progress.py` after a fresh build for current counts.
