...
.thumb_func_start Func_80ecedc
	push	{lr}
	mov	r1, #1
	bl	Func_80ecef4
	pop	{r0}
	bx	r0
.func_end Func_80ecedc

.thumb_func_start Func_80ecee8
	push	{lr}
	mov	r1, #2
	bl	Func_80ecef4
	pop	{r0}
	bx	r0
.func_end Func_80ecee8

.thumb_func_start Func_80ecef4
	push	{r5, r6, r7, lr}
	mov	r7, r8
	push	{r7}
...
.Led08e:
	...
	pop	{r0}
	bx	r0
.func_end Func_80ecef4

.thumb_func_start Func_80ed104
	push	{r5, r6, r7, lr}
	mov	r7, r11
	mov	r6, r10
	mov	r5, r9
