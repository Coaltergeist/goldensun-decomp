...
.thumb_func_start Func_801161c
	ldr	r2, =0x501
	ldr	r3, =REG_BG1CNT
	strh	r2, [r3]
	add	r3, #0xca
	ldr	r0, =ewram_2038000
	ldr	r1, =0x6008000
	ldr	r2, =0x84002000
	stmia	r3!, {r0, r1, r2}
	sub	r3, #0xc
	bx	lr
.func_end Func_801161c
...
.thumb_func_start Func_80118a8
	...
	strh	r3, [r2, #0x22]
	bx	lr
.func_end Func_80118a8

.thumb_func_start Func_80118c0
	ldr	r3, =iwram_3001e70
	ldr	r2, [r3]
	lsl	r3, r0, #1
	add	r3, r0
...
.thumb_func_start Func_8011ae0
	push	{lr}
	ldr	r0, =Func_80119cc
	bl	Func_80042c8
	pop	{r0}
	bx	r0
.func_end Func_8011ae0

.thumb_func_start Func_8011af0
	push	{lr}
	ldr	r0, =Func_80119cc
	bl	Func_800439c
	pop	{r0}
	bx	r0
.func_end Func_8011af0
