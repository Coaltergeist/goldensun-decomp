...
.thumb_func_start Func_80045e8
	ldr	r0, =.L779c
	bx	lr
.func_end Func_80045e8

.thumb_func_start Func_80045f0
	push	{lr}
...
.thumb_func_start Func_8004698
	push	{lr}
	ldr	r1, =iwram_3001cbc
	mov	r2, #0
	ldr	r3, [r1]
	cmp	r2, r0
	bcs	.L46bc
