...
.thumb_func_start Func_8005904
	push	{lr}
	ldr	r3, =ewram_2004c14
	lsl	r0, #16
	ldr	r3, [r3]
	lsr	r0, #16
	bl	_call_via_r3
...
.L5af0:
	...
	pop	{r1}
	bx	r1
.func_end Func_8005ae0

.thumb_func_start Func_8005b24
	push	{r5, r6, lr}
	ldr	r3, =iwram_3001f1c
	ldr	r3, [r3]
	mov	r1, r3
...
.L5c24:
	...
	pop	{r1}
	bx	r1
.func_end Func_8005c08

.thumb_func_start Func_8005c2c
	push	{r5, lr}
	ldr	r3, =iwram_3001f1c
	ldr	r3, [r3]
	mov	r1, r3
