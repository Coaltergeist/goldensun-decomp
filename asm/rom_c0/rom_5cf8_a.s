...
.thumb_func_start Func_8006358
	push	{lr}
	ldr	r2, =iwram_3001cb0
	ldr	r3, .L6378	@ 0
	mov	r0, #7
	strh	r3, [r2]
	mov	r1, #0
...
.L647a:
	...
	pop	{r0}
	bx	r0
.func_end Func_8006458

.thumb_func_start Func_8006488
	push	{r5, r6, lr}
