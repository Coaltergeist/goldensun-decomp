...
.thumb_func_start Func_80228bc
	push	{r5, lr}
	mov	r5, r0
	mov	r0, r1
	bl	Func_8004620
	ldr	r1, =iwram_3001f70
	mov	r2, #0xd
.L228ca:
	ldrb	r3, [r1]
	sub	r2, #1
	...
	pop	{r1}
	bx	r1
.func_end Func_80228bc

.thumb_func_start Func_80228e4
	push	{r5, r6, r7, lr}
	mov	r7, r11
	mov	r6, r10
	mov	r5, r9
