...
.thumb_func_start Func_8079ad8
	mov	r3, #0x54
	mul	r0, r3
	ldr	r3, =.L84b1c
	add	r0, r3
	bx	lr
.func_end Func_8079ad8
...
.thumb_func_start Func_8079bc4
	ldr	r1, =ewram_20023a8
	ldr	r3, =0x41c64e6d
	ldr	r2, [r1]
	mov	r0, r2
	mul	r0, r3
	...
	lsr	r0, #16
	bx	lr
.func_end Func_8079bc4

.thumb_func_start Func_8079be8
	push	{lr}
	bl	Func_8079bc4
	mov	r3, #0x64
	mul	r0, r3
...
.thumb_func_start Func_807a5b0
	push	{lr}
	bl	Func_807a0cc
	ldrh	r0, [r0]
	pop	{r1}
	bx	r1
.func_end Func_807a5b0
